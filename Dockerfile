...
ARG BUILDER=public.ecr.aws/eks-distro-build-tooling/golang:1.24.2-gcc
ARG BASE_IMAGE=public.ecr.aws/eks-distro/kubernetes/go-runner:v0.18.0-eks-1-32-latest
