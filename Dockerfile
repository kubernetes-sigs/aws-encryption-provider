...
ARG BUILDER=public.ecr.aws/eks-distro-build-tooling/golang:1.21.5-gcc
ARG BASE_IMAGE=public.ecr.aws/eks-distro/kubernetes/go-runner:v0.14.0-eks-1-26-25
